...
- A projectile follows a **parabolic** path due to the influence of gravity and air resistace.
- We consider both horizontal $x$ and vertical $y$ motion with an air resistance force proportional to velocity.

## Equations of Motion
The governing equations for the projectile motion with air resistance are:
...
- $x_0 = 0$, $y_0 = 0$ (starting position)
- $v_{x0} = 10$, $v_{y0} = 10$ (initial velocity components in m/s)
